...
function Vendor() {
    return (
                ...
                <div>
                    ...
                    <div className="wrapper">
                      <div className="pure-g">
                        <div className="pure-u-1-5">
                          <p className="mb20">
                            <i className="icon-header icon-header-arrow-left icon-left" />
                            <span className="tools-header-title pointer app-link" data-href="Vendors">
                              Retour              </span>
                          </p>
                          <div className="app-search-tags mr35 mt10">
                            <p className="tools-filters-title">Votre recherche</p>
                            <ul className="tools-filters-tags">
                              <li className="app-tag-filter-category tag-filter app-link" data-href="/tools/VendorsCateg?status=">
                                <span>Mariée et Accessoires</span>
                                <i className="svgIcon svgIcon__close tag-box-close">
                                  <svg viewBox="0 0 32 32" width={16} height={16}>
                                    <use xlinkHref="#svg-_common-close" />
                                  </svg>
                                </i>              </li>
                            </ul>
                          </div>
                          <div className="app-filter-vendor-category mr35 mt20">
                            <p className="tools-filters-title">Par Catégorie</p>
                            <ul className="tools-filters">
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=16&status=" data-id-categ={16}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Réception</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=27&status=" data-id-categ={27}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Traiteur</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=21&status=" data-id-categ={21}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Photo</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=163&status=" data-id-categ={163}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Vidéo</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={1}>1</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=17&status=" data-id-categ={17}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Musique</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=22&status=" data-id-categ={22}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Voiture</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=159&status=" data-id-categ={159}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Transports</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=18&status=" data-id-categ={18}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Faire-part</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=19&status=" data-id-categ={19}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Cadeaux aux invités</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=20&status=" data-id-categ={20}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Fleurs et Décoration</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=161&status=" data-id-categ={161}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Animation</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=160&status=" data-id-categ={160}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Organisation</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=164&status=" data-id-categ={164}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Officiants</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=162&status=" data-id-categ={162}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Wedding cake</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item  current" data-href="/tools/VendorsCateg?id_categ=23&status=" data-id-categ={23}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Mariée et Accessoires</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={1}>1</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=24&status=" data-id-categ={24}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Marié et Accessoires</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=28&status=" data-id-categ={28}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Beauté et bien-être</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=29&status=" data-id-categ={29}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Bijoux</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=25&status=" data-id-categ={25}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Lune de Miel</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item " data-href="/tools/VendorsCateg?id_categ=26&status=" data-id-categ={26}>
                                <span className="tools-filters-item-name tools-filters-item-name--colorLink">Autres</span>
                                <span className="tools-filters-item-count app-num-dress" data-count={0}>0</span>
                              </li>
                            </ul>
                          </div>
                          <div className="app-filter-vendor-status mr35 mt20">
                            <p className="tools-filters-title">Par état</p>
                            <ul className="tools-filters tools-filters-bullets app-filter-status">
                              <li className="tools-filters-item app-link tools-filters-item-red dnone" data-href="/tools/VendorsCateg?id_categ=23&status=1" data-status={1}>
                                <span className="tools-filters-item-name">Non disponible</span>
                                <span className="tools-filters-item-count" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item app-link tools-filters-item-red dnone" data-href="/tools/VendorsCateg?id_categ=23&status=2" data-status={2}>
                                <span className="tools-filters-item-name">Rejeté</span>
                                <span className="tools-filters-item-count" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item app-link tools-filters-item-orange " data-href="/tools/VendorsCateg?id_categ=23&status=3" data-status={3}>
                                <span className="tools-filters-item-name">A évaluer</span>
                                <span className="tools-filters-item-count" data-count={1}>1</span>
                              </li>
                              <li className="tools-filters-item app-link tools-filters-item-orange dnone" data-href="/tools/VendorsCateg?id_categ=23&status=4" data-status={4}>
                                <span className="tools-filters-item-name">Présélectionné</span>
                                <span className="tools-filters-item-count" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item app-link tools-filters-item-orange dnone" data-href="/tools/VendorsCateg?id_categ=23&status=5" data-status={5}>
                                <span className="tools-filters-item-name">En négociation</span>
                                <span className="tools-filters-item-count" data-count={0}>0</span>
                              </li>
                              <li className="tools-filters-item app-link tools-filters-item-green dnone" data-href="/tools/VendorsCateg?id_categ=23&status=6" data-status={6}>
                                <span className="tools-filters-item-name">Réservé</span>
                                <span className="tools-filters-item-count" data-count={0}>0</span>
                              </li>
                            </ul>
                          </div>
                        ...
                        <div className="pure-u-4-5">
                          <div className="pure-g mb20">
                            <div className="pure-u-1-2">
                              <h1 className="tools-title tools-title-inline">
                                Mariée et Accessoires                  </h1>
                              <span className="tools-header-count app-tools-vendors-categ-count" data-count={1}>
                                1 prestataire                          </span>
                            </div>
                            <div className="pure-u-1-2 tools-header-actionContainer">
                              <a className="pointer tools-toggle-action btn-flat red app-add-vendor-modal app-top-btn icon-tools icon-tools-plus-white icon-left" data-id-categ={23} href="/tools/VendorsAddNew?idCateg=23" role="button">Ajouter prestataire </a>              </div>
                          </div>
                          <hr />
                          <div className="app-tools-vendors-categ-detail">
                            <div className="pure-g">
                              <div className="pure-u-2-3">
                                <p className="vendors-result-subtitle">
                                  Vous n'avez toujours pas fait votre choix ?                    <a className="link--primary ml10" href="https://www.mariages.net/busc.php?id_grupo=3&id_provincia=485&id_region=32">
                                    Rechercher  sur Paris                                                                            <i className="icon icon-arrow-right-red icon-right" />
                                  </a>
                                </p>
                              </div>
                            </div>
                            <div className="app-success-box alert alert-success dnone" />
                            <div id="myVendorsCateg" className="pure-g vendors-saved">
                              <div className="pure-u-1-3 app-vendors-container app-tools-vendors-after-banner" data-filtervalue={3}>
                                <div className="app-tools-vendors-modif vendors-item" data-id-empresa={125525} data-id-escaparate data-listed={1} data-categ={23}>
                                  <input type="hidden" name="listed" defaultValue={1} />
                                  <input type="hidden" name="public" defaultValue={0} />
                                  <input type="hidden" name="valid" defaultValue={1} />
                                  <input type="hidden" name="idEmpresa" defaultValue={125525} />
                                  <figure className="vendors-item-header app-link img-zoom" data-href="https://www.mariages.net/accessoires-mariage/kesslord--e125525">
                                    <i className="app-vendors-item-remove vendors-item-remove icon-tools icon-tools-times-white" />
                                    <img className="app_toolsVendorsEdit" data-id-empresa={125525} src="https://cdn0.mariages.net/emp/fotos/5/5/2/5/r10_2x_kesslord-2-25-9038_3_125525.jpg" alt="Kesslord" />
                                    <figcaption className="vendors-item-header-info no-rating-stars">
                                      <p className="vendors-item-header-categ">Accessoires mariage</p>
                                      <p className="vendors-item-header-title">
                                        Kesslord                                      </p>
                                      <p className="vendors-item-header-location">
                                        Paris                                                                          </p>
                                    </figcaption>
                                  </figure>
                                  <div className="vendors-item-content">
                                    <div className="pure-g">
                                      <div className="vendors-item-select pure-u-1 ">
                                        <i className="app-tools-vendor-statuslabel vendors-item-select-icon icon-tools icon-tools-clock-orange" />
                                        <select name="Status" className="app-tools-vendors-select-status" data-valid={1}>
                                          <option value={1}>
                                          ...
                                          <option value={3} selected>
                                            A évaluer                                              </option>
                                          <option value={4}>
                                            Présélectionné                                              </option>
                                          <option value={5}>
                                            En négociation                                              </option>
                                          <option value={6}>
                                            Réservé                                              </option>
                                        </select>
                                        <i className="vendors-item-select-caret icon icon-caret-down-grey" />
                                      </div>
                                    </div>
                                    <div className="pure-g">
                                      <div className="pure-u-3-5">
                                        <div className="vendors-item-rating">
                                          <p className="input-group-line-label block ellipsis">
                                            <span className="app-tools-vendors-rating-text">Vous avez aimé ?</span>
                                          </p>
                                          <i className="app-tools-vendors-change-rating icon-tools icon-tools-heart-grey " data-rating={2} data-name="Insuffisant" />
                                          <i className="app-tools-vendors-change-rating icon-tools icon-tools-heart-grey " data-rating={3} data-name="Moyen" />
                                          <i className="app-tools-vendors-change-rating icon-tools icon-tools-heart-grey " data-rating={4} data-name="Bon" />
                                          <i className="app-tools-vendors-change-rating icon-tools icon-tools-heart-grey " data-rating={5} data-name="Très bon" />
                                          <i className="app-tools-vendors-change-rating icon-tools icon-tools-heart-grey " data-rating={6} data-name="Excellent" />
                                          <input className="app-tools-vendors-rating-input" type="hidden" defaultValue={1} name="Rating" />
                                        </div>
                                      </div>
                                      <div className="pure-u-2-5">
                                        <div className="app-tools-vendors-change-price vendors-item-price">
                                          <p className="input-group-line-label block">Prix</p>
                                          <input className="app-vendors-item-price-edit-value" placeholder={0} type="hidden" name="Precio" defaultValue={0} />
                                          <input className="app-vendors-item-price-edit vendors-item-price-edit" placeholder={0} type="text" name="PrecioTexto" defaultValue={0} style={{width: '9.79688px'}} />
                                          <span className="vendors-item-price-currency">
                                            €                                              </span>
                                        </div>
                                      </div>
                                    </div>
                                    <div className="app-vendors-note-main vendors-item-note">
                                      <span className="app-vendors-note app-vendors-note-add vendors-item-note-empty ">
                                        <span className="icon-tools icon-tools-note mr10" />Ajouter une note                                  </span>
                                      <p className="app-vendors-note app-vendors-note-snippet vendors-item-note-content dnone" />
                                    </div>
                                    <div className="app-vendors-tooltip vendors-item-note-tooltip form-line">
                                      <span className="input-group-line-label">Note</span>
                                      <textarea name="Notes" className="app-vendors-tooltip-textarea" placeholder="Écrivez vos notes sur l’entreprise..." defaultValue={""} />
                                      <span className="app-vendors-note-close fleft pointer mt25">
                                        <span className="icon icon-arrow-left mr10" />Retour                                  </span>
                                    </div>
                                    <div id="app-emp-phone-125525" className="vendors-item-dropdown pure-u-1" />
                                  </div>
                                  <footer className="vendors-item-footer">
                                    <div className="vendors-item-footer-section">
                                      <div className="app-vendors-item-solicitar">
                                        <a className="vendors-item-footer-action app-show-lead-layer app-ua-track-event" role="button" data-track-c="LeadTracking" data-track-a="a-step1" data-track-l="d-desktop+s-tools_vendors_categ" data-track-v={1} data-track-ni={0} data-track-cds="{&quot;dimension15&quot;:&quot;125525&quot;,&quot;dimension17&quot;:&quot;7&quot;}" data-id-empresa={125525} data-frm-insert="7)">
                                          <i className="icon-tools icon-tools-envelope icon-left" />
                                          Contact                                                          </a>
                                      </div>
                                    </div>
                                  </footer>
                            ...
                            <h2 className="tools-subtitle inline-block">Ces entreprises peuvent vous intéresser pour votre mariage</h2>
                            <div className="pure-g-r vendors-related">
                              <div className="pure-u-1-4">
                                <div data-track-c="RelatedContentTracking" data-track-a="a-click" data-track-l="d-desktop+s-related_content+o-tools_vendors_categ+dt-vendors_profile" data-track-v={0} data-track-ni={0} data-zorigen={59} className="vendors-related-item app-link app-tools-zorigen app-ua-track-event" data-href="https://www.mariages.net/robe-de-mariee/selestia--e172486">
                                  <div className="vendors-related-item-frame">
                                    <img className="vendors-related-item-img app_toolsVendorsEdit" data-id-empresa={172486} src="https://cdn0.mariages.net/emp/fotos/2/4/8/6/t10_s10109-5_3_172486-165659879766100.jpg" alt="Selestia" />
                                  </div>
                                  <div className="vendors-related-item-content">
                                    <p className="vendors-related-item-title">Robe de mariée</p>
                                    <a className="vendors-related-item-name" href="https://www.mariages.net/robe-de-mariee/selestia--e172486">
                                      Selestia                      </a>
                                    <div id="emp-profile-stars">
                                      <a className="storefront-header-stars" href="https://www.mariages.net/robe-de-mariee/selestia--e172486/avis">
                                        <div className="rating-stars-vendor">
                                          <span className="rating-stars-vendor rating-stars-vendor-bar" style={{width: '96%'}} />
                                        </div>
                                        <span className="rating-stars-vendor__count">13</span>
                                      </a>
                                    </div>
                              ...
                              <div className="pure-u-1-4">
                                <div data-track-c="RelatedContentTracking" data-track-a="a-click" data-track-l="d-desktop+s-related_content+o-tools_vendors_categ+dt-vendors_profile" data-track-v={0} data-track-ni={0} data-zorigen={59} className="vendors-related-item app-link app-tools-zorigen app-ua-track-event" data-href="https://www.mariages.net/robe-de-cocktail/paule-vasseur--e119639">
                                  <div className="vendors-related-item-frame">
                                    <img className="vendors-related-item-img app_toolsVendorsEdit" data-id-empresa={119639} src="https://cdn0.mariages.net/emp/fotos/9/6/3/9/t10_pv-2021-montana-giada-mikado-syam-bleu-01_3_119639-161081551239994.jpeg" alt="Paule Vasseur" />
                                  </div>
                                  <div className="vendors-related-item-content">
                                    <p className="vendors-related-item-title">Robe de mariée</p>
                                    <a className="vendors-related-item-name" href="https://www.mariages.net/robe-de-cocktail/paule-vasseur--e119639">
                                      Paule Vasseur                      </a>
                                    <div id="emp-profile-stars">
                                      <a className="storefront-header-stars" href="https://www.mariages.net/robe-de-cocktail/paule-vasseur--e119639/avis">
                                        <div className="rating-stars-vendor">
                                          <span className="rating-stars-vendor rating-stars-vendor-bar" style={{width: '92%'}} />
                                        </div>
                                        <span className="rating-stars-vendor__count">1</span>
                                      </a>
                                    </div>
                                    <p className="vendors-related-item-location">
                                      Paris, Paris                                                  </p>
                              ...
                              <div className="pure-u-1-4">
                                <div data-track-c="RelatedContentTracking" data-track-a="a-click" data-track-l="d-desktop+s-related_content+o-tools_vendors_categ+dt-vendors_profile" data-track-v={0} data-track-ni={0} data-zorigen={59} className="vendors-related-item app-link app-tools-zorigen app-ua-track-event" data-href="https://www.mariages.net/robe-de-mariee/fortunee--e137774">
                                  <div className="vendors-related-item-frame">
                                    <img className="vendors-related-item-img app_toolsVendorsEdit" data-id-empresa={137774} src="https://cdn0.mariages.net/emp/fotos/7/7/7/4/t10_img-20210712-192819-872_3_137774-162720671280767.jpg" alt="Fortunée" />
                                  </div>
                                  <div className="vendors-related-item-content">
                                    <p className="vendors-related-item-title">Robe de mariée</p>
                              ...
                              <div className="pure-u-1-4">
                                <div data-track-c="RelatedContentTracking" data-track-a="a-click" data-track-l="d-desktop+s-related_content+o-tools_vendors_categ+dt-vendors_profile" data-track-v={0} data-track-ni={0} data-zorigen={59} className="vendors-related-item app-link app-tools-zorigen app-ua-track-event" data-href="https://www.mariages.net/robe-de-mariee/pivoines-and-love--e235988">
                                  <div className="vendors-related-item-frame">
                                    <img className="vendors-related-item-img app_toolsVendorsEdit" data-id-empresa={235988} src="https://cdn0.mariages.net/emp/fotos/5/9/8/8/t10_5b113-3-walysa_3_235988-160985403614918.jpg" alt="Pivoines and Love" />
                                  </div>
                                  <div className="vendors-related-item-content">
                                    <p className="vendors-related-item-title">Robe de mariée</p>
                                    <a className="vendors-related-item-name" href="https://www.mariages.net/robe-de-mariee/pivoines-and-love--e235988">
                                      Pivoines and Love                      </a>
                                    <div id="emp-profile-stars">
                                      <a className="storefront-header-stars" href="https://www.mariages.net/robe-de-mariee/pivoines-and-love--e235988/avis">
                                        <div className="rating-stars-vendor">
                                          <span className="rating-stars-vendor rating-stars-vendor-bar" style={{width: '99%'}} />
                                        </div>
                                        <span className="rating-stars-vendor__count">12</span>
                                      </a>
                                    </div>
                                    <p className="vendors-related-item-location">
                                      Paris, Paris                                                  </p>
                            ...
                            <p className="text-center mt20 mb20">
                              <a data-track-c="RelatedContentTracking" data-track-a="a-click" data-track-l="d-desktop+s-related_content+o-tools_vendors_categ+dt-vendors_list" data-track-v={0} data-track-ni={0} className="btn-outline outline-red tools-more-link app-tools-zorigen app-ua-track-event" data-zorigen={59} rel="nofollow" href="https://www.mariages.net/robe-de-mariee/paris/paris">
                                Voir plus      </a>
                            </p>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{display: 'none'}}>
                              <symbol>
                                <svg id="svg-_common-close" viewBox="0 0 26 26"><path d="M12.983 10.862L23.405.439l2.122 2.122-10.423 10.422 10.423 10.422-2.122 2.122-10.422-10.423L2.561 25.527.439 23.405l10.423-10.422L.439 2.561 2.561.439l10.422 10.423z" fillRule="nonzero" /></svg>  </symbol>
                            </svg>  </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="chat-conversation app-chat-conversation" data-initconversation={0}>
                        ...
                        <div className="app-mobile-nel-scrollfix chat-messages chat-messages--chatbot app-scroll-calculate">
                          <div className="app-conversation-parts chat-messages__inner "><div className="chat-message-welcome">
                            ...
                            </div><div className="chat__separator"><span>16/08/2022</span></div><div className="app-income-message message-income">
                              <div className="chat-message message-income">
                                ...
                                <div className="chat-message-globe">
                                  ...
                                  <div className="chat__timestamp">18:29</div>
                                </div>
                              </div>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{display: 'none'}}>
                    <symbol>
                      <svg id="svg-_common-close" viewBox="0 0 26 26"><path d="M12.983 10.862L23.405.439l2.122 2.122-10.423 10.422 10.423 10.422-2.122 2.122-10.422-10.423L2.561 25.527.439 23.405l10.423-10.422L.439 2.561 2.561.439l10.422 10.423z" fillRule="nonzero" /></svg><svg id="svg-_common-heart" viewBox="0 0 34 30"><path d="M26.232.086C30.653.716 34 4.68 34 9.858c0 1.41-.371 2.884-1.073 4.412-1.35 2.937-3.878 6.013-7.247 9.134a68.921 68.921 0 01-5.582 4.625c-.665.496-1.284.941-1.84 1.328-.335.233-.577.396-.71.483a1 1 0 01-1.097 0c-.132-.087-.374-.25-.71-.483a67.429 67.429 0 01-1.84-1.328 68.921 68.921 0 01-5.58-4.625c-3.37-3.121-5.898-6.197-7.248-9.134C.371 12.742 0 11.268 0 9.858 0 4.681 3.347.716 7.768.086 11.6-.46 15.091 1.616 17 5.778 18.91 1.617 22.4-.46 26.232.086z" fillRule="nonzero" /></svg><svg id="svg-_common-angleDown" viewBox="0 0 18 18"><path d="M16.9 5.6c-.2-.2-.5-.2-.7 0L9 12.8 1.8 5.6c-.2-.2-.5-.2-.7 0s-.2.5 0 .7l7.5 7.5v.1c.1.1.3.1.4.1.1 0 .3 0 .4-.1v-.1l7.5-7.5c.2-.2.2-.5 0-.7z" /></svg>  </symbol>
                  </svg>
