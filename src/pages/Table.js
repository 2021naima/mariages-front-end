...
function Table() {
      return (
        <div>
          ...
          <main id="layoutMain">
            <div className="wrapper-tools-tables wrapper-tools-tables--dfp-enabled">
              <span className="tools-tables-left-uncollapse app-tools-grid-menu-open">
                <i className="icon-tools icon-tools-double-arrow-right icon-left" />Menu  </span>
              <div id="app-tools-grid-menu" className="tools-tables-left ">
                <div>
                  <span className="tools-tables-left-collapse app-tools-grid-menu-close">
                    <i className="icon-tools icon-tools-double-arrow-left icon-left" />Cacher          </span>
                </div>
                <div className="tools-tables-left-content separator">
                  <p className="tools-tables-left-title">Ajouter table</p>
                  <div className="pure-g mt20 va-flex-middle">
                    <div className="pure-u-1-3 text-center">
                      <a rel="nofollow" className="inline-block app-icon-hover" data-icon-new="icon-tools-table-3-active" data-icon-old="icon-tools-table-3" role="button">
                        <i className="app-create-table icon-tools icon-tools-table-3 pointer text-center ui-draggable ui-draggable-handle" data-type="2side" />
                      </a>
                    </div>
                    <div className="pure-u-1-3 text-center">
                      <a rel="nofollow" className="inline-block app-icon-hover" data-icon-new="icon-tools-table-2-active" data-icon-old="icon-tools-table-2" role="button">
                        <i className="app-create-table icon-tools icon-tools-table-2 pointer text-center ui-draggable ui-draggable-handle" data-type="1side" />
                      </a>
                    </div>
                    <div className="pure-u-1-3 text-center">
                      <a rel="nofollow" className="inline-block app-icon-hover" data-icon-new="icon-tools-table-1-active" data-icon-old="icon-tools-table-1" role="button">
                        <i className="app-create-table icon-tools icon-tools-table-1 pointer text-center ui-draggable ui-draggable-handle" data-type="round2" />
                      </a>
                    </div>
                  </div>
                </div>
                <div className="tools-tables-left-content pb0">
                  <div className="flex">
                    <p className="tools-tables-left-title">Invités</p>
                    <div className="tools-tables-left-switch">
                      <span className="app-pending-seat pointer" data-pending={0}>Tout</span> |
                      <span className="app-pending-seat pointer current" data-pending={1}>En attente</span>
                    </div>
                  </div>
                  <button className="btnFlat btnFlat--primary btnFlat--full tools-tables-left-content-addGuest mt10 mb20 app-layer-add-guest" data-remote="https://www.mariages.net/tools/TablesGuestsAdd" data-id-event>
                    Ajouter invité(e)          </button>
                  <div className="tools-tables-leftSearch">
                    <i className="icon-tools icon-tools-search" />
                    <input className="app-tables-guest-search" placeholder="Chercher des invités" />
                  </div>
                </div>
                <div className="tools-tables-left-content">
                  <div className="tools-tables-left-guests app-tables-guest-list">
                    <div className="app-tools-tables-group" style={{display: 'none'}}>
                      <p className="app-tools-tables-group-title tools-tables-left-guests-family-title">Marié</p>
                      <ul className="app-tools-tables-group-family tools-tables-left-guests-family" style={{display: 'none'}}>
                        <li data-position={0} data-proxy="guestProxyAdult" data-grupo={1} data-edad data-nombre="Ma moitié" data-apellidos data-seat-id="table1_s4" data-mesa="table1" data-parent={55608821} data-idcontact={55608821} data-confirmado={1} id="i55608821" className="app-tables-persona app-tables-persona-list tools-tables-left-guests-item ui-draggable ui-draggable-handle" style={{display: 'none'}}>
                          <span className="app-tables-guest-name tools-tables-left-guests-name parent marked-text">Ma moitié </span>
                          <i className="app-tables-guest-icon icon-tools fright relative icon-tools-guest-dropped dropped" />
                        </li>
                      </ul>
                      <ul className="app-tools-tables-group-family tools-tables-left-guests-family" style={{display: 'none'}}>
                        <li data-position={0} data-proxy="guestProxyNovia" data-grupo={1} data-edad data-nombre="naima bourhym" data-apellidos data-seat-id="table1_s3" data-mesa="table1" data-parent={55608819} data-idcontact={55608819} data-confirmado={1} id="i55608819" className="app-tables-persona app-tables-persona-list tools-tables-left-guests-item ui-draggable ui-draggable-handle" style={{display: 'none'}}>
                          <span className="app-tables-guest-name tools-tables-left-guests-name parent marked-text">naima bourhym </span>
                          <i className="app-tables-guest-icon icon-tools fright relative icon-tools-guest-dropped dropped" />
                        </li>
                      </ul>
                    </div>
                    <div className="app-tools-tables-group" style={{display: 'none'}}>
                      <p className="app-tools-tables-group-title tools-tables-left-guests-family-title">Non attribué</p>
                      <ul className="app-tools-tables-group-family tools-tables-left-guests-family" style={{display: 'none'}}>
                        <li data-position={0} data-proxy="guestProxyAdult" data-grupo={0} data-edad data-nombre="etr" data-apellidos data-seat-id data-mesa data-parent={55637073} data-idcontact={55637073} data-confirmado={0} id="i55637073" className="app-tables-persona app-tables-persona-list tools-tables-left-guests-item ui-draggable ui-draggable-handle" style={{display: 'none'}}>
                          <span className="app-tables-guest-name tools-tables-left-guests-name parent marked-text">etr </span>
                          <i className="app-tables-guest-icon icon-tools fright relative icon-tools-guest-dropped dropped" />
                        </li>
                      </ul>
                    </div>
                    <div id="app-zero-persona" style={{}}>
                      <div className="tools-tables-guests-empty">
                        <strong>Il n’y a pas d'invités à placer</strong>
                        <p>Ajoutez des invités à votre liste et faites-les glisser vers leur table</p>
                        <span className="tools-tables-left-addGuest app-layer-add-guest" data-remote="https://www.mariages.net/tools/TablesGuestsAdd" data-id-event>
                          <i className="icon-tools icon-tools-tables-add-red icon-left" />Ajouter      </span>
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="tools-tables-right-content">
                <div className="wrapper-tables-header-buttons main">
                  <div className="input-group tools-toggle icon icon-arrow-down" style={{display: 'none'}}>
                    <select className="event-select app-multi-event" data-idevent data-url="https://www.mariages.net/tools/Tables?idEvent=">
                    </select>
                  </div>
                  <div className="tools-toggle">
                    <a className="tools-toggle-item active" href="https://www.mariages.net/tools/Tables">Plan</a>
                    <a className="tools-toggle-item " href="/tools/TablesReport">Liste</a>
                  </div>
                  <div className="tools-toggle">
                    <span className="app-open-layer-pdf tools-toggle-item" data-section="main"><i className="icon-tools icon-tools-download icon-left" />
                      PDF</span>
                  </div>
                </div>
                <div className="app-tables-viewbox tools-tables-viewbox ui-resizable ui-droppable" style={{width: '529px', height: '450px'}}>
                  <div className="app-tables-content tools-tables-content"><div id="table1" className="app-mesa-item tools-tables-gridItem ui-draggable ui-draggable-handle ui-droppable" style={{left: '159px', top: '84px', position: 'absolute', visibility: 'visible', zIndex: 999999}} data-invitados data-numchairs={6} data-type="1side" data-name="Table d'Honneur" data-posx={159} data-posy={84}>
                      <div className="tools-tables-gridItem-settings app-table-settings" style={{display: 'none'}}>
                        <div className="app-table-remove mb15" data-id="table1">
                          <i className="icon-tools icon-tools-tables-trash" />
                          <i className="icon-tools icon-tools-tables-trash-hover dnone" />
                        </div>
                        <div className="app-table-edit mb15" data-id="table1">
                          <i className="icon-tools icon-tools-tables-edit" />
                          <i className="icon-tools icon-tools-tables-edit-hover dnone" />
                        </div>
                        <div className="app-rotate-table">
                          <i className="icon-tools icon-tools-tables-rotate" />
                          <i className="icon-tools icon-tools-tables-rotate-hover dnone" />
                        </div>
                      </div>
                      <div style={{height: '34px', marginBottom: '-6px'}}>
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s1"><div className="app-tables-persona app-seated-guest ui-draggable ui-draggable-handle" data-idcontact={55637073}>
                            <div className="tools-tables-gridItem-guest">
                              <i className="app-tables-guest-icon icon-tools icon-tools-adult" />
                            </div>
                            <div className="app-tables-persona-name tools-tables-gridItem-guestName" title="etr ">
                              <span>etr</span>
                              <span />
                            </div>
                          </div></div>
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s2" />
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s3"><div className="app-tables-persona app-seated-guest ui-draggable ui-draggable-handle" data-idcontact={55608819}>
                            <div className="tools-tables-gridItem-guest">
                              <i className="app-tables-guest-icon icon-tools icon-tools-bride" />
                            </div>
                            <div className="app-tables-persona-name tools-tables-gridItem-guestName" title="naima bourhym ">
                              <span>naima bourhym</span>
                              <span />
                            </div>
                          </div></div>
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s4"><div className="app-tables-persona app-seated-guest ui-draggable ui-draggable-handle" data-idcontact={55608821}>
                            <div className="tools-tables-gridItem-guest">
                              <i className="app-tables-guest-icon icon-tools icon-tools-adult" />
                            </div>
                            <div className="app-tables-persona-name tools-tables-gridItem-guestName" title="Ma moitié ">
                              <span>Ma moitié</span>
                              <span />
                            </div>
                          </div></div>
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s5" />
                        <div style={{margin: '0px 7px', float: 'left', opacity: 1}} className="app-table-seat tools-tables-gridItem-seat ui-droppable" id="table1_s6" />
                      </div>
                      <div className="tools-tables-gridItem-table tools-tables-gridItem-square" style={{height: '50px', width: '300px'}}>
                        <div className="tools-tables-gridItem-squareLabel " id="table1_label">&nbsp;Table d'Honneur&nbsp;</div>
                      </div>
                    </div></div>
                  <div id="app-container-data" className="dnone" />
                  <div className="ui-resizable-handle ui-resizable-e" style={{zIndex: 90, display: 'block'}} /><div className="ui-resizable-handle ui-resizable-s" style={{zIndex: 90, display: 'block'}} /><div className="ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se" style={{zIndex: 90}} /></div>
              </div>
            </div>
            <div id="app-table-info" data-panel-width={889} data-panel-height={550} />
          </main>
                  ...
                  <div className="app-conversation-parts chat-messages__inner "><div className="chat-message-welcome">
                      ...
                      <div className="chat-message message-income">
                        ...
                        <div className="chat-message-globe">
                          ...
                          <div className="chat__timestamp">13:44</div>
                        </div>
                      </div>
